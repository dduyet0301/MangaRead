...
class MangaDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bookmarked = cache.itemExist(mangaTitle: mangaTitle, entity: Global.BOOKMARK_COREDATA)
    ...
    @objc func bookmarking() {
        ...
        if bookmarked {
            cache.delete(mangaTitle: title, entity: Global.BOOKMARK_COREDATA)
        } else {
            cache.save(manga: Manga.init(title: title
                , image: image, latestChapter: latest, url: urlDetail), entity: Global.BOOKMARK_COREDATA)
        }
